...
![CI](https://github.com/YOUR_USERNAME/firewall_optimizer/actions/workflows/ci.yml/badge.svg)
...
git clone https://github.com/YOUR_USERNAME/firewall_optimizer.git
cd firewall_optimizer
